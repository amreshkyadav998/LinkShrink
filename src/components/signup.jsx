...
const Signup = () => {
  ...
  const { fetchUser } = UrlState(); // Ensure UrlState is correctly provided and used
  ...
  }, [data, error, navigate, longLink, loading, fetchUser]);
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      await fnSignup(); // Call the signup function
    } catch (e) {
      const newErrors = {};
      e?.inner?.forEach((err) => {
